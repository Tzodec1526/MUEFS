/** Outline of the State of Michigan (both peninsulas), drawn in currentColor. */
function MichiganMark({ size = 26 }: { size?: number }) {
  return (
    <svg
      className="michigan-outline"
      viewBox="730 175 155 135"
      width={size}
      height={Math.round(size * (135 / 155))}
      aria-hidden="true"
      focusable="false"
    >
